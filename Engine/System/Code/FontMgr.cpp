...
void CFontMgr::Render_Font(wstring pFontTag, wstring pString, const _vec2 * pPos, D3DXCOLOR Color)
{
...
CMyFont * CFontMgr::Find_Font(wstring pFontTag)
{
	auto	iter = find_if(m_mapFont.begin(), m_mapFont.end(), CTag_Finder2(pFontTag));
