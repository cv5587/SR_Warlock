#include "stdafx.h"
#include "..\Header\MiniMapUITex.h"

#include "Export_Utility.h"
#include "Export_System.h"

CMiniMapUITex::CMiniMapUITex(LPDIRECT3DDEVICE9 pGraphicDev)
...
CMiniMapUITex::CMiniMapUITex(const CMiniMapUITex& rhs)
...
CMiniMapUITex::~CMiniMapUITex()
{
}

HRESULT CMiniMapUITex::Ready_GameObject(wstring TextureTag, float fSizeX, float fSizeY, float fX, float fY, float fZ, bool noLines)
{
	m_fSizeX = fSizeX;
	m_fSizeY = fSizeY;
...
Engine::_int CMiniMapUITex::Update_GameObject(const _float& fTimeDelta)
{
...
void CMiniMapUITex::LateUpdate_GameObject(const float& fTimeDelta)
{
	__super::LateUpdate_GameObject(fTimeDelta);
}

void CMiniMapUITex::Render_GameObject()
{
...
HRESULT CMiniMapUITex::Add_Component(wstring TextrueTag)
{
...
CMiniMapUITex* CMiniMapUITex::Create(LPDIRECT3DDEVICE9 pGraphicDev, wstring TextureTag,float fSizeX, float fSizeY, float fX, float fY, float fZ, bool noLines)
{
	CMiniMapUITex* pInstance = new CMiniMapUITex(pGraphicDev);
