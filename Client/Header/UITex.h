...
class CUITex : public Engine::CGameObject
{
private:
...
private:
	...
	int					m_texIdx = 0;
public:
	static CUITex* Create(LPDIRECT3DDEVICE9	pGraphicDev, wstring TextrueTag, float fSizeX, float fSizeY, float fX, float fY,float fZ, bool noLines = true);
